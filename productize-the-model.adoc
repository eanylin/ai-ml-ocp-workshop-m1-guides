...
Note that the code directly above this is not meant to be run but serves as an illustration for the user to take note of the versioning of the data as well as introduce the use of a bigger training file in the pipeline.
