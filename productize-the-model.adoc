...
We have prepared the refactored model at `/projects/datascience-examples/workshop/src/train/lr.ans.py`. Copy it to `/projects/{{USER_MODEL_REPO_NAME}}/workshop/src/train/lr.py`

[source,bash,role="copypaste"]
----
cp /projects/{{USER_MODEL_REPO_NAME}}/workshop/src/train/lr.ans.py /projects/{{USER_MODEL_REPO_NAME}}/workshop/src/train/lr.py
----
...
[source,bash,role="copypaste"]
----
/projects/{{USER_MODEL_REPO_NAME}}/workshop/src/train/train-dev.sh
----
...
[source,bash,role="copypaste"]
----
cd /projects/{{USER_MODEL_REPO_NAME}}/workshop/src/seldon/
./app.sh
----
...
[source,bash,role="copypaste"]
----
/projects/{{USER_MODEL_REPO_NAME}}/workshop/bin/dev-test.sh
----
...
----
cd /projects/{{USER_MODEL_REPO_NAME}}/workshop/src/train
git add *
