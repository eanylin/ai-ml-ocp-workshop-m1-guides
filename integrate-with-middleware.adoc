...
After sending the transactions, you can now go to the http://webnotifications-{{  USER_ID }}-prod.apps.cluster-27ee.27ee.sandbox629.opentlc.com[notification^] page to see the end results.
