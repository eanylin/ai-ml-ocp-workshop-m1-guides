...
image:%7B%%20image_path%20kubernetes-components.png%20%%7D[k8s_architecture]
...
https://github.com/kubernetes/community/blob/master/contributors/devel/sig-node/container-runtime-interface.md[Kubernetes
